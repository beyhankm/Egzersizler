...
public class Main {
    public static void main (String[] args){
        /*
        Kullanıcıdan Vize1, Vize2 ve Final notunu alarak bir harf hesaplama sistemi yapın.
        ...
        Final toplam notun %40'ına erki edecek.
        ...
        System.out.println("Genel ortalamanız: ");
        ...
        if (toplamnot>=90){
            ...
            if (ortalama < 2.50){
                System.out.println("Bu dersi yeniden alabilirsiniz.");
            }
        }
